...
(function (factory) {
    ...
    var clndrTemplate =
        ...
        "<div class='cover-table'>" +
            "<table id='clndr-table' class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
                "<thead>" +
                ...
                "<% for(var i = 0; i < numberOfRows; i++){ %>" +
                    ...
                    "<% var d = j + i * 7; %>" +
                        "<td class='<%= days[d].classes %>'>" +
                            "<div class='day-contents'><span><%= ((days[d].day).toString().length < 2 ? '0' + days[d].day : days[d].day) %></span></div>" +
                        "</td>" +
                    "<% } %>" +
                    "</tr>" +
                "<% } %>" +
